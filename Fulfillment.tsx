...
const FulfillmentDetailModal: React.FC<FulfillmentDetailModalProps> = ({ isOpen, onClose, order, onUpdateStatus }) => {
                        ...
                        <tbody className="divide-y">
                            {order.items.map(item => (
                                <tr key={item.drugId}>
                                    ...
                                    <td className="p-3 text-gray-800 font-semibold">{item.quantity.toLocaleString()}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
...
const Fulfillment: React.FC<FulfillmentProps> = ({ orders, onUpdateOrder }) => {
