...
const App: React.FC = () => {
            ...
            switch (command.type) {
                ...
                case 'CREATE_QUICK_SALE': {
                    ...
                    if (!customerName || !remoteItems) {
                        addToast(`دستور فاکتور سریع نامعتبر بود.`, 'error');
                        return;
                    }
                    ...
                    for (const remoteItem of remoteItems) {
                        ...
                        if (!drug) {
                            addToast(`دستور از ریموت ناموفق بود: محصول با شناسه ${remoteItem.drugId} یافت نشد.`, 'error');
                            return; // Abort
                        }
                    ...
                    addToast(`فاکتور سریع از ریموت برای ${customerName} دریافت و ثبت شد!`, 'success');
                    break;
                }
    ...
    }, [currentUser, licenseInfo, addToast, drugs, orders]);
